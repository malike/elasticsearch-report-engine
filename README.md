...
to have easy access to the template files and the generated reports can now be accessed over HTTP as CSV,PDF or HTML as an option as ``Base64`` encoded text.
